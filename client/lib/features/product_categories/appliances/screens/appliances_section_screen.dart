...
class AppliancesSectionScreen extends StatelessWidget with CommonWidgets {
  static const String routeName = '/appliances';

  const AppliancesSectionScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> groceries =
        GlobalVariables.productHierarchy['Appliances']?.keys.toList() ?? [];
                ...
                return GestureDetector(
                  onTap: () {
                    ...
                    productBloc.add(FetchProductsByCategory(
                        categories: ['Appliances', groceries[index]]));
                  ...
                  child: Column(
                    children: [
                      SizedBox(
                        ...
                        child: Image.asset(
                          GlobalVariables.appliancesIcons[groceries[index]] ??
                              '',
                          fit: BoxFit.contain,
